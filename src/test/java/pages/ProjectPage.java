...
public class ProjectPage extends BasePage {
    ...
    @Step("Filling new Project data with Private access (Add All)")
    public ProjectPage fillInPrivateAll(Project project) {
        log.info("Filling new Account data {}", project);
    ...
    @Step("Filling new Project data with Private access (Add All)")
    public ProjectPage fillInPrivate(Project project) {
        log.info("Filling new Account data {}", project);
        $(byText(PRIVATE_CHECK_CSS)).click();
